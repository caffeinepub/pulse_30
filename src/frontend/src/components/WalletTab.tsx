        ...
        <div className="pb-4">
          ...
          {isAdmin && (
            <div
              ...
              data-ocid="wallet.analytics.panel"
            >
              <div className="flex items-center gap-2 mb-3">
                <BarChart3
                  className="h-4 w-4"
                    ...
                    [
                      {
                        ...
                        ocid: "wallet.analytics.total_users",
                      },
                      {
                        label: "Messages Sent",
                        value: Number(
                        ...
                        ocid: "wallet.analytics.messages_sent",
                      },
                      {
                        label: "Gold Volume",
                        value: `${GOLD_SYMBOL} ${(Number(analytics.totalGoldVolume) / 100).toFixed(2)}`,
                        ocid: "wallet.analytics.gold_volume",
                      },
                      {
                        label: "Active Users",
                        value: Number(analytics.activeUsers).toLocaleString(),
                        ocid: "wallet.analytics.active_users",
                      },
                      {
                        label: "Channels",
                        value: Number(
                          analytics.channelsCreated,
                        ).toLocaleString(),
                        ocid: "wallet.analytics.channels_created",
                      },
                      {
                        label: "Stories Posted",
                        value: Number(analytics.storiesPosted).toLocaleString(),
                        ocid: "wallet.analytics.stories_posted",
                      },
                    ] as const
                  ).map((stat) => (
                    <div
                      ...
                      style={{
                        background: "oklch(0.18 0.04 60 / 0.5)",
                        border: "1px solid oklch(0.82 0.15 72 / 0.1)",
                      }}
                      data-ocid={stat.ocid}
                    >
                      ...
                      <span
                        className="text-lg font-bold font-display leading-none truncate"
                        style={{ color: "oklch(0.82 0.15 72)" }}
                      >
                        {stat.value}
                      </span>
