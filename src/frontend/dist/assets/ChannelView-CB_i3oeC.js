  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      children: [
        ...
        post.content.mediaUrl && mediaKind === "other" && embedVariant === "embedTikTok" && (() => {
          const videoId = extractTikTokId(post.content.mediaUrl);
          if (!videoId)
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full overflow-hidden rounded-xl flex justify-center bg-black", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "iframe",
            {
              src: `https://www.tiktok.com/embed/v2/${videoId}`,
              className: "w-full",
              style: { height: "560px", maxWidth: "325px" },
