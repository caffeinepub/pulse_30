...
function TikTokPreviewCard({ url }) {
  var _a;
  const videoId = (_a = url.match(/\/video\/(\d+)/)) == null ? void 0 : _a[1];
  if (!videoId) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-bold", children: "TT" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "TikTok Video" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: url })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-4 w-4 text-muted-foreground shrink-0" })
        ]
      }
    );
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "iframe",
    {
...
function XPreviewCard({ url }) {
  ...
  reactExports.useEffect(() => {
    if (!(data == null ? void 0 : data.html) || !containerRef.current) return;
    containerRef.current.innerHTML = data.html;
    const activate = () => {
      var _a, _b;
      return (_b = (_a = window.twttr) == null ? void 0 : _a.widgets) == null ? void 0 : _b.load(containerRef.current ?? void 0);
    };
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-white text-xs font-bold", children: "𝕏" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Post on X" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: url })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-4 w-4 text-muted-foreground shrink-0" })
        ]
  ...
  if (!(data == null ? void 0 : data.html)) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3 rounded-xl border border-border bg-muted/30", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "w-8 h-8 rounded-full flex items-center justify-center shrink-0",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-w-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold", children: "Loading post…" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 text-muted-foreground shrink-0 animate-spin" })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      children: [
        ...
        post.content.mediaUrl && mediaKind === "other" && embedVariant === "embedTikTok" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TikTokPreviewCard, { url: post.content.mediaUrl }) }),
        post.content.mediaUrl && mediaKind === "other" && embedVariant === "embedX" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(XPreviewCard, { url: post.content.mediaUrl }) }),
...
function ChannelView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1 min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 pb-8 flex flex-col gap-4", children: postsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "channel.view.loading_state", children: [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 rounded-2xl mb-4" }, i)) }) : sortedPosts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
