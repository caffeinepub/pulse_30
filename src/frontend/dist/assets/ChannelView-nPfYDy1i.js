...
function TikTokEmbed({ url }) {
  ...
  reactExports.useEffect(() => {
    ...
    fetch(oEmbedUrl).then((r) => {
      ...
      const win = window;
      if ((_a = win.tiktokEmbed) == null ? void 0 : _a.lib) {
