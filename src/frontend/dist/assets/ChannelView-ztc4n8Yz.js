    ...
    "article",
    {
      ...
      children: [
        ...
        post.content.mediaUrl && mediaKind === "other" && embedVariant === "embedYouTube" && (() => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "iframe",
            {
        ...
        post.content.mediaUrl && mediaKind === "other" && embedVariant === "embedTikTok" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground truncate", children: post.content.mediaUrl })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-4 w-4 text-muted-foreground shrink-0" })
            ]
          }
        ),
        post.content.mediaUrl && mediaKind === "other" && embedVariant === "embedX" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: post.content.mediaUrl,
            target: "_blank",
