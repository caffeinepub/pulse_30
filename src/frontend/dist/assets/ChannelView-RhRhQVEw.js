...
function TikTokPreviewCard({ url }) {
  ...
  reactExports.useEffect(() => {
    let cancelled = false;
    fetch(`https://www.tiktok.com/oembed?url=${encodeURIComponent(url)}`).then((r) => r.json()).then((json) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "a",
    {
      ...
      children: [
        (data == null ? void 0 : data.thumbnail_url) && /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            (data == null ? void 0 : data.author_name) && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-foreground/80 truncate", children: [
              "@",
              data.author_name
            ] }),
            (data == null ? void 0 : data.title) && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium leading-snug line-clamp-2", children: data.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
...
function XPreviewCard({ url }) {
  ...
  const tweetText = (data == null ? void 0 : data.html) ? stripHtmlTags(data.html).slice(0, 120) : null;
  if (failed || !data) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "a",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          data.author_name && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold text-foreground", children: data.author_name }),
          tweetText && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground/80 mt-1 leading-snug", children: [
            tweetText,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "h-4 w-4 text-muted-foreground shrink-0 mt-0.5" })
      ] })
    }
  );
}
