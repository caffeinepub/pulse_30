import { c as createLucideIcon, r as reactExports, u as useListUserConversations, a as useForwardChannelPost, j as jsxRuntimeExports, D as Dialog, b as DialogContent, d as DialogHeader, e as DialogTitle, S as Search, I as Input, f as ScrollArea, L as LoaderCircle, B as Button, g as ue, h as useGetUserProfile, A as Avatar, i as AvatarImage, k as AvatarFallback, l as useGetChannelPostInteractions, m as useLikeChannelPost, n as useUnlikeChannelPost, o as useCommentOnChannelPost, H as Heart, M as MessageCircle, p as Share2, q as Send, s as useGetChannel, t as useGetChannelPosts, v as useFollowChannel, w as useUnfollowChannel, x as useAddChannelPost, y as useMediaUpload, z as useDeleteChannel, C as Skeleton, E as ArrowLeft, U as Users, F as DropdownMenu, G as DropdownMenuTrigger, J as EllipsisVertical, K as DropdownMenuContent, N as DropdownMenuItem, O as SquarePen, P as AlertDialog, Q as AlertDialogContent, R as AlertDialogHeader, T as AlertDialogTitle, V as AlertDialogDescription, W as AlertDialogFooter, X as AlertDialogCancel, Y as AlertDialogAction, Z as Textarea, _ as Image, $ as Video, a0 as Mic, a1 as useUpdateChannel, a2 as Camera, a3 as Label } from "./index-BV4At8xK.js";
/**
...
function ChannelView({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full min-h-0", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "flex-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 flex flex-col gap-4", children: postsLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": "channel.view.loading_state", children: [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-32 rounded-2xl mb-4" }, i)) }) : sortedPosts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
    ...
    ) : sortedPosts.map((post, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      ChannelPostCard,
      {
        post,
